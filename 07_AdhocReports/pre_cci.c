# 1 "c:\\project\\pvr\\pvr47\\scripts\\adhocscripts\\07_adhocreports\\\\combined_07_AdhocReports.c"
...
# 1 "c:\\project\\pvr\\pvr47\\scripts\\adhocscripts\\07_adhocreports\\\\combined_07_AdhocReports.c" 2
...
# 2 "c:\\project\\pvr\\pvr47\\scripts\\adhocscripts\\07_adhocreports\\\\combined_07_AdhocReports.c" 2
...
# 3 "c:\\project\\pvr\\pvr47\\scripts\\adhocscripts\\07_adhocreports\\\\combined_07_AdhocReports.c" 2
...
# 4 "c:\\project\\pvr\\pvr47\\scripts\\adhocscripts\\07_adhocreports\\\\combined_07_AdhocReports.c" 2
...
Action()
{
	...
	lr_end_transaction("Rep7_T01_OpenApplication",2);
	...
	lr_end_transaction("Rep7_T02_Login",2);
	...
	lr_end_transaction("Rep7_T03_NavigateAdhocReport_NewReport",2);

	lr_think_time(3);

	lr_start_transaction("Rep7_T04_ClickProductLookUp");

	lr_end_transaction("Rep7_T04_ClickProductLookUp",2);
	...
	lr_end_transaction("Rep7_T05_SearchProduct",2);
	...
	lr_end_transaction("Rep7_T06_SelectProduct",2);
	...
	lr_end_transaction("Rep7_T07_SelectReportTemplate",2);
	...
	lr_end_transaction("Rep7_T08_SelectReportQuery", 2);
...
web_submit_data("run", 
		...
		"Name=emailConfiguration.body", "Value=<div style=\"display: none;\">&nbsp;</div>\r\n<div>&nbsp;</div>", "ENDITEM", 
	...
	web_url("{User_Id}", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1599816541445", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t7.inf", 
	...
	web_url("executionStatus", 
		...
		"columns%5B10%5D%5Bsearch%5D%5Bregex%5D=false&order%5B0%5D%5Bcolumn%5D=5&order%5B0%5D%5Bdir%5D=desc&start=0&length=50&search%5Bvalue%5D=&search%5Bregex%5D=false&tableFilter=%7B%7D&advancedFilter=false&sharedwith=&searchString=&direction=desc&sort=runDate&status=GENERATING&_=1599816541446", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t8.inf", 
	...
	lr_end_transaction("Rep7_T09_SaveAndRun",2);
	...
	lr_end_transaction("Rep7_T10_Logout",2);

	lr_think_time(3);

	return 0;
}
# 5 "c:\\project\\pvr\\pvr47\\scripts\\adhocscripts\\07_adhocreports\\\\combined_07_AdhocReports.c" 2
...
# 6 "c:\\project\\pvr\\pvr47\\scripts\\adhocscripts\\07_adhocreports\\\\combined_07_AdhocReports.c" 2
